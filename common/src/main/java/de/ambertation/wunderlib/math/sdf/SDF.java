...
import org.betterx.bclib.misc.CommonRegistryBuilder;
import org.betterx.bclib.misc.RegistryAttribute;
...
//                                visitor.visit(pd, new EvaluationData(dd, ed.source), false);
    ...
    //---------------------- SDF REGISTRY ----------------------
    public static final MappedRegistry<MapCodec<? extends SDF>> SDF_REGISTRY = CommonRegistryBuilder
            .<MapCodec<? extends SDF>>createSimple(null, BCLib.makeID("sdf"))
    ...
    static MapCodec<? extends SDF> register(
        ...
        return Registry.register(registry, BCLib.makeID(name), codec.codec());
    }
