...
import org.betterx.wover.WoverClientFabric;

public class BCLibClientFabric implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ModelLoadingPlugin.register(BCLibClientFabric::onInitializeModelLoader);
        ...
        WoverClientFabric.onClientInitialize();
    }
    ...
    private static void onInitializeModelLoader(ModelLoadingPlugin.Context pluginContext) {
        ...
        pluginContext.resolveModel().register(BCLibClientFabric::resolveModel);
        pluginContext.modifyModelOnLoad().register(BCLibClientFabric::modifyModelOnLoad);
    }
