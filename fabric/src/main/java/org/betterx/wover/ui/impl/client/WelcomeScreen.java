...
public class WelcomeScreen extends WoverLayoutScreen {
    public static final ResourceLocation BETTERX_LOCATION = WoverFabric.C_UI.id("betterx.png");
    public static final ResourceLocation BACKGROUND = WoverFabric.C_UI.id("header.png");
    public static final ResourceLocation ICON_BETTERNETHER = WoverFabric.C_UI.id("icon_betternether.png");
    public static final ResourceLocation ICON_BETTEREND = WoverFabric.C_UI.id("icon_betterend.png");
    public static final ResourceLocation ICON_BCLIB = WoverFabric.C_UI.id("icon_bclib.png");
