...
public abstract class WoverLayoutScreen extends LayoutScreenWithIcon {
    public static final ResourceLocation WOVER_LOGO_LOCATION = WoverFabric.C_UI.id("icon.png");
    public static final ResourceLocation WOVER_LOGO_WHITE_LOCATION = WoverFabric.C_UI.id("icon_bright.png");
